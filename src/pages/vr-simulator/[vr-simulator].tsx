...
import VrSimulatorPage from '@/src/features/vr-simulator/presentation/page/VrSimulatorPage';
...
export default function VrSimulator() {
  ...
  return (
    <>
      <Head>
        <title>{`Vr Simulator ${title ? `| ${title}` : ''}`}</title>
      </Head>
      <VrSimulatorPage />
    </>
  );
...
VrSimulator.getLayout = function getLayout(page: ReactElement) {
